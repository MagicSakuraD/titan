/**
 * @typedef {Object} OpenDriveMapConfig
 * @property {boolean} with_lateralProfile
 * @property {boolean} with_laneHeight
 * @property {boolean} with_road_objects
 * @property {boolean} center_map
 * @property {boolean} abs_z_for_for_local_road_obj_outline
 */

/**
 * @typedef {Object} OpenDriveMap
 * @property {function(string, OpenDriveMapConfig): OpenDriveMap} constructor
 * @property {function(): any[]} get_roads
 */

/**
 * @typedef {Object} FS
 * @property {function(string, string | Uint8Array, Object=): void} writeFile
 */

/**
 * @typedef {Object} ModuleOpenDrive
 * @property {function(): Promise<ModuleOpenDrive>} default
 * @property {OpenDriveMap} OpenDriveMap
 * @property {FS} FS
 */
...
var libOpenDrive = (() => {
  ...
  return function (libOpenDrive) {
    ...
    var wasmBinaryFile;
    wasmBinaryFile = "ModuleOpenDrive.wasm";
    ...
    var asmLibraryArg = {
      ...
      H: ___syscall_ioctl,
      I: ___syscall_openat,
      p: __embind_finalize_value_array,
    ...
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["R"]).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_jiji = (Module["dynCall_jiji"] = function () {
      return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["Z"]).apply(
        null,
        arguments
      );
    });
...
else if (typeof exports === "object") exports["libOpenDrive"] = libOpenDrive;
